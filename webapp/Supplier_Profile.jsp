...
<ul style="margin-right:40px;">
  ...
  <li style="background-color: black;"><a href="Admin_Profile.jsp" style="color:white;">Profile</a></li>
</ul>
<br><br><br><br>
...
<form action="user" style="display:none;margin-top:20px;margin-left:300px;width:500px;" id="form">
	<fieldset>
		...
		<span>* Do not change phone number or category !</span><br><br>
		...
		<input type="text" id="category" name="category" style="font-weight:bold;" value="<%=category%>" required><br><br>
